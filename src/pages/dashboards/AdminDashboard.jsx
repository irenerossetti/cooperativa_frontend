    ...
    <div className="space-y-6">
      ...
      <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <button className="bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-200 px-4 py-3 rounded-lg transition-colors text-sm font-medium">
            Nuevo Socio
          </button>
          <button className="bg-blue-500/20 hover:bg-blue-500/30 text-blue-200 px-4 py-3 rounded-lg transition-colors text-sm font-medium">
            Nueva Parcela
          </button>
          <button className="bg-purple-500/20 hover:bg-purple-500/30 text-purple-200 px-4 py-3 rounded-lg transition-colors text-sm font-medium">
            Registrar Cosecha
          </button>
          <button className="bg-orange-500/20 hover:bg-orange-500/30 text-orange-200 px-4 py-3 rounded-lg transition-colors text-sm font-medium">
            Nueva Campaña
          </button>
        </div>
      </div>
